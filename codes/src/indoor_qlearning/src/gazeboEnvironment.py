...
#%% Class to initialize the gazebo environment. The instance of this class is part of the turtlebot controller. It mainly controls the simulation environment
